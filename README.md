...
### Suspend your disbelief and pretend that Harry Potter is still relevant.
...
+ Wands_Property: The code is the code of the wand, age is the age of the wand, and is_evil denotes whether the wand is good for the dark arts. If the value of is_evil is 0, it means that the wand is not evil. The mapping between code and age is one-one, meaning that if there are two pairs, (code<sub>1</sub>, age<sub>1</sub>) and (code<sub>2</sub>, age<sub>2</sub>), then code<sub>1</sub> != code<sub>2</sub> and age<sub>1</sub> != age<sub>2</sub>.
